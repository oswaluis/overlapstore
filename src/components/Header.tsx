...
import { Box, Container, Flex, IconButton, Menu, MenuButton, MenuItem, MenuList, Show, Spacer } from '@chakra-ui/react'
...
export function Header(){
    return(
        <Box as='header' width='100%' color='#121212' borderBottom='solid 2px #46BBC0'>
            <Container as = {Flex} size='lg' justifyContent='space-between' alignItems='center' padding={1}>
